    ...
    <div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/bank2.jpg" class="d-block w-100" alt="..." height="490px" >
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
          <div class="carousel-item">
            <img src="img\picture2.jpeg" class="d-block w-100" alt="..." height="490px" >
            <div class="carousel-caption d-none d-md-block"> 
            </div>
          </div>
          <div class="carousel-item">
            <img src="img\bgimage.png" class="d-block w-100" alt="..." height="490px">
            <div class="carousel-caption d-none d-md-block">   
            </div>
          </div>
        </div>
...
<div class="bg-light services-section ">
...
<div class="inner-width">
    ...
    <h3 class="section-title1" id="offer">OUR SERVICES</h3>
...
<section id="contactus">
                ...
                <div class="row pt-3 " id="contact_section ">
                    ...
                    <div class=" col-md-6 order-md-last order-first mt-4 ">
                        <iframe src="
                                    ...
                                    contact_map" allowfullscreen=" " loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-light text-center text-white">
        ...
        <div class="text-center" style="background-color: black; font-weight: 700;">
            ...
            Copyright &copy; Hetvi Savla All rights reserved
        
        <div id="center-1">
            <ul>
                <li class="items"><a href="index.php">HOME </a></li>
                <li class="items"><a href="#card1">SERVICES</a></li>
                <li class="items"><a href="/aboutus.html">LOANS </a></li>
                <li class="items"><a href="/contactus.html">ABOUT US </a></li>
